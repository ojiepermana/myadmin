# Relation 0043. Operasi destructive table
...
> spec 0041 (designer sebagai rumah aksi; kompilasi DDL provider).
...
| `references` | [0040. Manajemen schema](../0040-schema-management/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
