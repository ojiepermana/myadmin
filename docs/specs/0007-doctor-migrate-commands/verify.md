# Verify 0007. Perintah doctor dan migrate
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0007-AC1` | Integration | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `IT-0007-AC2` | Integration | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `SEC-0007-AC3` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-4](test.md#ac-4) | `UT-0007-AC4` | Unit | output command dan assertion | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0007-AC5` | Integration | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `IT-0007-AC6` | Integration | output command dan assertion | Belum dijalankan |
| [AC-7](test.md#ac-7) | `CT-0007-AC7` | Contract | output command dan assertion | Belum dijalankan |
...
|---|---|---|
| Unit | Script root yang didaftarkan pada satu `package.json` | Semua `UT-0007-*` lulus dan memiliki assertion yang menutup AC. |
| Integration | Script root yang didaftarkan pada satu `package.json` | Resource nyata disposable dipakai dan cleanup lulus. |
| Contract | Script root yang didaftarkan pada satu `package.json` | Semua `CT-0007-*` lulus dan memiliki assertion yang menutup AC. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0007-*` lulus dan memiliki assertion yang menutup AC. |
