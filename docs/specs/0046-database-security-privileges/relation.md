# Relation 0046. Security database target: privilege (grant dan revoke)
...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0045. Security database target: principal](../0045-database-security-principals/index.md) | Indeks build dan konteks spec |
