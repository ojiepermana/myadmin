...
| ------------------- | ---------------------------------------------------- |
| Status spec         | Assumed                                              |
| Build plan          | 14 dari 15 langkah selesai                           |
| Acceptance criteria | 15 AC: 9 PASS, 5 PARTIAL, 1 BLOCKED                  |
...
| 13  | `concurrency` workflow, determinisme realtime, proteksi  | AC-13      | Sebagian; proteksi branch belum |
