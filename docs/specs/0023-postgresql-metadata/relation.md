# Relation 0023. Provider PostgreSQL: metadata dan introspeksi
...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0022. Provider PostgreSQL: koneksi, TLS, capability, error mapping](../0022-postgresql-connection-capability/index.md) | Indeks build dan konteks spec |
...
|---|---|---|
| `enables` | [0031. Object explorer](../0031-object-explorer/index.md) | Spec ini harus selesai sebelum konsumen dimulai |

## Relasi nonblocking dan handoff

| Jenis awal | Spec | Cara membaca relasi |
|---|---|---|
| `references` | [0021. Kontrak database-core, capability model, dan registry](../0021-database-core-contracts/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0025. Provider MySQL: metadata dan introspeksi](../0025-mysql-metadata/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0041. Table designer: kolom dan properti](../0041-table-designer-columns/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0032. Object search](../0032-object-search/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0033. Query editor: tab dan eksekusi](../0033-query-editor-execution/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0042. Table designer: index dan constraint](../0042-table-designer-indexes-constraints/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
