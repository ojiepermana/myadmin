...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0049. Backup](../0049-backup/index.md) | Indeks build dan konteks spec |
...
|---|---|---|
| `references` | [0028. Jobs infrastructure](../0028-jobs-infrastructure/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `references` | [0039. Manajemen database](../0039-database-management/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `references` | [0048. Import](../0048-import-jobs/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
