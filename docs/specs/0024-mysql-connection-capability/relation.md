# Relation 0024. Provider MySQL: koneksi, TLS, capability, error mapping
...
> spec 0021. Selaras dengan spec 0022 (pola yang sama; kedua spec bisa dikerjakan berurutan atau paralel oleh orang berbeda).
