# Verify 0024. Provider MySQL: koneksi, TLS, capability, error mapping
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0024-AC1` | Integration | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `IT-0024-AC2`, `SEC-0024-AC2` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0024-AC3`, `SEC-0024-AC3` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0024-AC4`, `CT-0024-AC4` | Integration, Contract | output command dan assertion | Belum dijalankan |
| [AC-5](test.md#ac-5) | `UT-0024-AC5`, `SEC-0024-AC5` | Unit, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-6](test.md#ac-6) | `IT-0024-AC6` | Integration | output command dan assertion | Belum dijalankan |
| [AC-7](test.md#ac-7) | `IT-0024-AC7`, `CT-0024-AC7` | Integration, Contract | output command dan assertion | Belum dijalankan |
| [AC-8](test.md#ac-8) | `CT-0024-AC8` | Contract | output command dan assertion | Belum dijalankan |
...
|---|---|---|
| Unit | Script root yang didaftarkan pada satu `package.json` | Semua `UT-0024-*` lulus dan memiliki assertion yang menutup AC. |
| Integration | Script root yang didaftarkan pada satu `package.json` | Resource nyata disposable dipakai dan cleanup lulus. |
| Contract | Script root yang didaftarkan pada satu `package.json` | Semua `CT-0024-*` lulus dan memiliki assertion yang menutup AC. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0024-*` lulus dan memiliki assertion yang menutup AC. |
