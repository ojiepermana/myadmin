...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0029-AC1`, `SEC-0029-AC1` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-2](test.md#ac-2) | `IT-0029-AC2`, `CT-0029-AC2` | Integration, Contract | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0029-AC3`, `SEC-0029-AC3` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0029-AC4`, `E2E-0029-AC4` | Integration, E2E | output command dan assertion | Belum dijalankan |
| [AC-5](test.md#ac-5) | `UT-0029-AC5`, `IT-0029-AC5` | Unit, Integration | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `UT-0029-AC6`, `IT-0029-AC6` | Unit, Integration | output command dan assertion | Belum dijalankan |
| [AC-7](test.md#ac-7) | `IT-0029-AC7`, `SEC-0029-AC7` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-8](test.md#ac-8) | `IT-0029-AC8` | Integration | output command dan assertion | Belum dijalankan |
...
|---|---|---|
| Unit | Script root yang didaftarkan pada satu `package.json` | Semua `UT-0029-*` lulus dan memiliki assertion yang menutup AC. |
| Integration | Script root yang didaftarkan pada satu `package.json` | Resource nyata disposable dipakai dan cleanup lulus. |
| Contract | Script root yang didaftarkan pada satu `package.json` | Semua `CT-0029-*` lulus dan memiliki assertion yang menutup AC. |
| E2E | Script root yang didaftarkan pada satu `package.json` | Semua `E2E-0029-*` lulus dan memiliki assertion yang menutup AC. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0029-*` lulus dan memiliki assertion yang menutup AC. |
