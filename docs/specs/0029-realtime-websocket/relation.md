# Relation 0029. Realtime WebSocket dan klien SDK
...
> spec 0017, 0028. Menyempurnakan spec 0027 (mengganti polling status).
...
| `references` | [0027. Connection manager: lifecycle dan status](../0027-connection-lifecycle-status/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
