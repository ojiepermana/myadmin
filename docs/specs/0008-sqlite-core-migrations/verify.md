# Verify 0008. SQLite core dan migration runner
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0008-AC1` | Integration | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `IT-0008-AC2` | Integration | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0008-AC3` | Integration | output command dan assertion | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0008-AC4` | Integration | output command dan assertion | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0008-AC5` | Integration | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `IT-0008-AC6` | Integration | output command dan assertion | Belum dijalankan |
| [AC-7](test.md#ac-7) | `IT-0008-AC7` | Integration | output command dan assertion | Belum dijalankan |
| [AC-8](test.md#ac-8) | `IT-0008-AC8` | Integration | output command dan assertion | Belum dijalankan |
