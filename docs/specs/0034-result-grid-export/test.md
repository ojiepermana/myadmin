...
**Execution**: Parsial lokal — helper/route suite **24 test, 138 assertions**, query-editor E2E dan 5.000-row virtual-grid performance lulus; visual, accessibility penuh, dan benchmark lintas environment belum lengkap.
