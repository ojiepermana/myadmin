# Relation 0034. Result grid dan export result
...
|---|---|---|
| `references` | [0014. UI foundation dan theme](../0014-ui-foundation-theme/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
