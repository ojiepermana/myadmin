# Relation 0014. UI foundation dan theme
...
> spec 0001. Persistensi preferensi ke server menunggu spec 0017 (sesi); sebelum itu preferensi hidup di localStorage.
...
|---|---|---|
| `enables` | [0015. App shell dan navigation](../0015-app-shell-navigation/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
...
| `coordinates` atau `deferred` | [0052. Settings dan preferences](../0052-settings-preferences/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
