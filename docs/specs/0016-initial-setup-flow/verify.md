# Verify 0016. Initial setup end to end
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0016-AC1` | Integration | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `E2E-0016-AC2` | E2E | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0016-AC3`, `SEC-0016-AC3` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0016-AC4` | Integration | output command dan assertion | Belum dijalankan |
| [AC-5](test.md#ac-5) | `E2E-0016-AC5` | E2E | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `SEC-0016-AC6` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-7](test.md#ac-7) | `IT-0016-AC7`, `SEC-0016-AC7` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-8](test.md#ac-8) | `E2E-0016-AC8`, `VIS-0016-AC8` | E2E, Visual dan accessibility | output command dan assertion; screenshot dengan viewport dan state terkunci | Belum dijalankan |
| [AC-9](test.md#ac-9) | `E2E-0016-AC9` | E2E | output command dan assertion | Belum dijalankan |
...
| E2E | Script root yang didaftarkan pada satu `package.json` | Semua `E2E-0016-*` lulus dan memiliki assertion yang menutup AC. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0016-*` lulus dan memiliki assertion yang menutup AC. |
