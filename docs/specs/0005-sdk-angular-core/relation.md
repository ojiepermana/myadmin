# Relation 0005. SDK Angular core
...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0004. Pipeline codegen dan contract test](../0004-codegen-pipeline-contract-tests/index.md) | Indeks build dan konteks spec |

Tidak ada dependency kelompok tambahan dari indeks.

## Konteks prasyarat dari spec utama

> spec 0004. Terkait: spec 0014 (paket UI dipasang di sana; SDK hanya memakai bagian infrastruktur non visualnya).
...
|---|---|---|
| `references` | [0002. Quality tooling dan CI](../0002-quality-tooling-ci/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
...
| `coordinates` atau `deferred` | [0014. UI foundation dan theme](../0014-ui-foundation-theme/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
