# Relation 0040. Manajemen schema
...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0039. Manajemen database](../0039-database-management/index.md) | Indeks build dan konteks spec |
...
|---|---|---|
| `references` | [0031. Object explorer](../0031-object-explorer/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
