# Relation 0026. Connection manager: CRUD dan vault
...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0011. Credential vault dan redaction](../0011-credential-vault-redaction/index.md) | Indeks build dan konteks spec |
| `requires` | [0017. Login, logout, dan session](../0017-login-session/index.md) | Indeks build dan konteks spec |
...
| `requires` | [0024. Provider MySQL: koneksi, TLS, capability, error mapping](../0024-mysql-connection-capability/index.md) | Indeks build dan konteks spec |

Tidak ada dependency kelompok tambahan dari indeks.

## Konteks prasyarat dari spec utama

> spec 0011, 0017, 0022, 0024.
...
|---|---|---|
| `enables` | [0027. Connection manager: lifecycle dan status](../0027-connection-lifecycle-status/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
...
| `references` | [0009. Internal repositories](../0009-internal-repositories/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
| `references` | [0018. User management dan change password](../0018-user-management-change-password/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
