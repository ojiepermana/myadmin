...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0026-AC1`, `CT-0026-AC1` | Integration, Contract | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `IT-0026-AC2`, `SEC-0026-AC2` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0026-AC3`, `SEC-0026-AC3` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0026-AC4`, `SEC-0026-AC4` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0026-AC5`, `E2E-0026-AC5` | Integration, E2E | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `IT-0026-AC6`, `SEC-0026-AC6` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-7](test.md#ac-7) | `IT-0026-AC7`, `E2E-0026-AC7` | Integration, E2E | output command dan assertion | Belum dijalankan |
| [AC-8](test.md#ac-8) | `SEC-0026-AC8` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-9](test.md#ac-9) | `IT-0026-AC9`, `SEC-0026-AC9` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-10](test.md#ac-10) | `E2E-0026-AC10`, `VIS-0026-AC10` | E2E, Visual dan accessibility | output command dan assertion; screenshot dengan viewport dan state terkunci | Belum dijalankan |
...
| Contract | Script root yang didaftarkan pada satu `package.json` | Semua `CT-0026-*` lulus dan memiliki assertion yang menutup AC. |
| E2E | Script root yang didaftarkan pada satu `package.json` | Semua `E2E-0026-*` lulus dan memiliki assertion yang menutup AC. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0026-*` lulus dan memiliki assertion yang menutup AC. |
