# Relation 0051. Monitoring status dasar
...
| `references` | [0029. Realtime WebSocket dan klien SDK](../0029-realtime-websocket/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
