# Relation 0006. CLI runtime dan data directory
...
> spec 0001. Perintah `doctor` dan `migrate` menyusul di spec 0007; migrasi dipanggil dari boot begitu spec 0008 ada.
...
|---|---|---|
| `enables` | [0007. Perintah doctor dan migrate](../0007-doctor-migrate-commands/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0008. SQLite core dan migration runner](../0008-sqlite-core-migrations/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0010. Key provider dan password hashing](../0010-key-provider-password-hashing/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0012. Package config](../0012-config-package/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
