# Verify 0006. CLI runtime dan data directory
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0006-AC1` | Integration | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `UT-0006-AC2` | Unit | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0006-AC3`, `SEC-0006-AC3` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0006-AC4` | Integration | output command dan assertion | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0006-AC5` | Integration | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `IT-0006-AC6` | Integration | output command dan assertion | Belum dijalankan |
| [AC-7](test.md#ac-7) | `IT-0006-AC7`, `SEC-0006-AC7` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-8](test.md#ac-8) | `UT-0006-AC8` | Unit | output command dan assertion | Belum dijalankan |
...
|---|---|---|
| Unit | Script root yang didaftarkan pada satu `package.json` | Semua `UT-0006-*` lulus dan memiliki assertion yang menutup AC. |
| Integration | Script root yang didaftarkan pada satu `package.json` | Resource nyata disposable dipakai dan cleanup lulus. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0006-*` lulus dan memiliki assertion yang menutup AC. |
