...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0023. Provider PostgreSQL: metadata dan introspeksi](../0023-postgresql-metadata/index.md) | Indeks build dan konteks spec |
| `requires` | [0025. Provider MySQL: metadata dan introspeksi](../0025-mysql-metadata/index.md) | Indeks build dan konteks spec |
...
|---|---|---|
| `enables` | [0032. Object search](../0032-object-search/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0037. Data browser: jalur baca](../0037-data-browser-read/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0039. Manajemen database](../0039-database-management/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0041. Table designer: kolom dan properti](../0041-table-designer-columns/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0044. Manajemen view (CRUD GUI)](../0044-view-management/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0045. Security database target: principal](../0045-database-security-principals/index.md) | Spec ini harus selesai sebelum konsumen dimulai |

## Relasi nonblocking dan handoff

| Jenis awal | Spec | Cara membaca relasi |
|---|---|---|
| `references` | [0029. Realtime WebSocket dan klien SDK](../0029-realtime-websocket/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0043. Operasi destructive table](../0043-table-destructive-operations/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
