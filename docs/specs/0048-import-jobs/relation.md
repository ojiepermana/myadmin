...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0047. Export](../0047-export-jobs/index.md) | Indeks build dan konteks spec |
...
| `references` | [0028. Jobs infrastructure](../0028-jobs-infrastructure/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
