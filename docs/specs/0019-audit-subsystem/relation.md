# Relation 0019. Subsistem audit append only
...
| `references` | [0016. Initial setup end to end](../0016-initial-setup-flow/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
