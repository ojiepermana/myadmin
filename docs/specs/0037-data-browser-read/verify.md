...
| AC-6, AC-7 | Filter/search/sort UI, export state, dan real two-engine browser flow sudah terbukti; direct explorer-to-data-browser, visual/accessibility, serta seluruh matrix acceptance masih belum lengkap. | Acceptance UI tetap parsial.                  | Lengkapi E2E direct explorer flow dan review visual/accessibility.                 |
