...
| AC-6, AC-7 | Filter/search/sort UI dan export state sudah terbukti; view read-only, visual/accessibility, serta full two-engine browser proof belum seluruhnya dibuktikan.  | Acceptance UI tetap parsial.                  | Jalankan E2E khusus view/two-engine dan review visual/accessibility.               |
