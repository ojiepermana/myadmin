# Relation 0013. Package observability
...
| `requires` | [0012. Package config](../0012-config-package/index.md) | Indeks build dan konteks spec |

Tidak ada dependency kelompok tambahan dari indeks.

## Konteks prasyarat dari spec utama

> spec 0011 (redaction), 0012 (log level dari config).
