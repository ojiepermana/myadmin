# Verify 0013. Package observability
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `UT-0013-AC1` | Unit | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `IT-0013-AC2` | Integration | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0013-AC3` | Integration | output command dan assertion | Belum dijalankan |
| [AC-4](test.md#ac-4) | `SEC-0013-AC4` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0013-AC5`, `SEC-0013-AC5` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-6](test.md#ac-6) | `UT-0013-AC6` | Unit | output command dan assertion | Belum dijalankan |
| [AC-7](test.md#ac-7) | `IT-0013-AC7` | Integration | output command dan assertion | Belum dijalankan |
...
|---|---|---|
| Unit | Script root yang didaftarkan pada satu `package.json` | Semua `UT-0013-*` lulus dan memiliki assertion yang menutup AC. |
| Integration | Script root yang didaftarkan pada satu `package.json` | Resource nyata disposable dipakai dan cleanup lulus. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0013-*` lulus dan memiliki assertion yang menutup AC. |
