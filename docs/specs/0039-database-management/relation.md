# Relation 0039. Manajemen database
...
|---|---|---|
| `enables` | [0040. Manajemen schema](../0040-schema-management/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
...
| `coordinates` atau `deferred` | [0044. Manajemen view (CRUD GUI)](../0044-view-management/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0046. Security database target: privilege (grant dan revoke)](../0046-database-security-privileges/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
