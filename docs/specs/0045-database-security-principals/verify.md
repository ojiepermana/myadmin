...
| 2026-08-30 | working tree | Playwright local web server dengan API fixture | Database security UI **2 passed dalam 6,7 detik**; principal lifecycle, reset/drop, secret-safe form, dan capability-disabled state lulus. | [Database security UI evidence](../evidence/2026-08-30-security-ui.md) |
...
| 2026-08-30 | Working tree | PostgreSQL/MySQL disposable 55433/3380, authenticated browser UI                                          | **4 pass, 0 fail dalam 12,3 detik**; principal lifecycle, reset/drop, audit-safe response, dan capability-driven security flow kembali lulus pada kedua engine                    | `MYADMIN_REAL_DATABASE_E2E=1 PLAYWRIGHT_HTML_OPEN=never bunx playwright test --config playwright.config.ts tests/e2e/web/zz-real-security.spec.ts`                                                    |
