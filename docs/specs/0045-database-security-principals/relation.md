# Relation 0045. Security database target: principal
...
|---|---|---|
| `enables` | [0046. Security database target: privilege (grant dan revoke)](../0046-database-security-privileges/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
...
| `references` | [0041. Table designer: kolom dan properti](../0041-table-designer-columns/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `references` | [0039. Manajemen database](../0039-database-management/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
