# Relation 0004. Pipeline codegen dan contract test
...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0003. Struktur kontrak OpenAPI v1 dan error model](../0003-openapi-contract-structure/index.md) | Indeks build dan konteks spec |
...
|---|---|---|
| `enables` | [0005. SDK Angular core](../0005-sdk-angular-core/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
