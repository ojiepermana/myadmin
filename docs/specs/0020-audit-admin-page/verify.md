...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0020-AC1`, `SEC-0020-AC1` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-2](test.md#ac-2) | `IT-0020-AC2` | Integration | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0020-AC3`, `SEC-0020-AC3` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-4](test.md#ac-4) | `E2E-0020-AC4`, `SEC-0020-AC4` | E2E, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-5](test.md#ac-5) | `E2E-0020-AC5` | E2E | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `PERF-0020-AC6` | Performance | output command dan assertion; dataset, baseline, ambang, pengulangan, dan toleransi | Belum dijalankan |
| [AC-7](test.md#ac-7) | `E2E-0020-AC7` | E2E | output command dan assertion | Belum dijalankan |
