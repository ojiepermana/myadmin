# Relation 0027. Connection manager: lifecycle dan status
...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0026. Connection manager: CRUD dan vault](../0026-connection-manager-crud/index.md) | Indeks build dan konteks spec |
...
| `enables` | [0033. Query editor: tab dan eksekusi](../0033-query-editor-execution/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0051. Monitoring status dasar](../0051-monitoring-status/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
...
| `coordinates` atau `deferred` | [0029. Realtime WebSocket dan klien SDK](../0029-realtime-websocket/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `references` | [0024. Provider MySQL: koneksi, TLS, capability, error mapping](../0024-mysql-connection-capability/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
