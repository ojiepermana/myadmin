...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `UT-0028-AC1` | Unit | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `UT-0028-AC2` | Unit | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `UT-0028-AC3` | Unit | output command dan assertion | Belum dijalankan |
| [AC-4](test.md#ac-4) | `UT-0028-AC4` | Unit | output command dan assertion | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0028-AC5`, `CT-0028-AC5`, `SEC-0028-AC5` | Integration, Contract, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-6](test.md#ac-6) | `UT-0028-AC6`, `E2E-0028-AC6` | Unit, E2E | output command dan assertion | Belum dijalankan |
| [AC-7](test.md#ac-7) | `UT-0028-AC7`, `SEC-0028-AC7` | Unit, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-8](test.md#ac-8) | `UT-0028-AC8` | Unit | output command dan assertion | Belum dijalankan |
...
|---|---|---|
| Unit | Script root yang didaftarkan pada satu `package.json` | Semua `UT-0028-*` lulus dan memiliki assertion yang menutup AC. |
| Integration | Script root yang didaftarkan pada satu `package.json` | Resource nyata disposable dipakai dan cleanup lulus. |
| Contract | Script root yang didaftarkan pada satu `package.json` | Semua `CT-0028-*` lulus dan memiliki assertion yang menutup AC. |
| E2E | Script root yang didaftarkan pada satu `package.json` | Semua `E2E-0028-*` lulus dan memiliki assertion yang menutup AC. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0028-*` lulus dan memiliki assertion yang menutup AC. |
