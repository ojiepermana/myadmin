# Relation 0022. Provider PostgreSQL: koneksi, TLS, capability, error mapping
...
> spec 0021. Server PostgreSQL test tersedia lewat `tests/environments/docker-compose.test.yml`.
...
|---|---|---|
| `enables` | [0023. Provider PostgreSQL: metadata dan introspeksi](../0023-postgresql-metadata/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
...
|---|---|---|
| `coordinates` atau `deferred` | [0047. Export](../0047-export-jobs/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0048. Import](../0048-import-jobs/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0049. Backup](../0049-backup/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0050. Restore](../0050-restore/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |

## Prasyarat environment atau manusia

| Jenis | Kebutuhan | Bukti kesiapan |
|---|---|---|
| `environment` | spec 0021. Server PostgreSQL test tersedia lewat tests/environments/docker-compose.test.yml. | Dicatat sebelum build atau verify dimulai. |
