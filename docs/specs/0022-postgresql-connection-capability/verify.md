# Verify 0022. Provider PostgreSQL: koneksi, TLS, capability, error mapping
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0022-AC1` | Integration | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `IT-0022-AC2`, `SEC-0022-AC2` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0022-AC3` | Integration | output command dan assertion | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0022-AC4`, `SEC-0022-AC4` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0022-AC5`, `CT-0022-AC5` | Integration, Contract | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `UT-0022-AC6`, `SEC-0022-AC6` | Unit, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-7](test.md#ac-7) | `IT-0022-AC7` | Integration | output command dan assertion | Belum dijalankan |
| [AC-8](test.md#ac-8) | `IT-0022-AC8`, `CT-0022-AC8` | Integration, Contract | output command dan assertion | Belum dijalankan |
| [AC-9](test.md#ac-9) | `CT-0022-AC9` | Contract | output command dan assertion | Belum dijalankan |
...
|---|---|---|
| Unit | Script root yang didaftarkan pada satu `package.json` | Semua `UT-0022-*` lulus dan memiliki assertion yang menutup AC. |
| Integration | Script root yang didaftarkan pada satu `package.json` | Resource nyata disposable dipakai dan cleanup lulus. |
| Contract | Script root yang didaftarkan pada satu `package.json` | Semua `CT-0022-*` lulus dan memiliki assertion yang menutup AC. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0022-*` lulus dan memiliki assertion yang menutup AC. |
