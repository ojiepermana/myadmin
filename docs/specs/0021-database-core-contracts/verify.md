...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `CT-0021-AC1` | Contract | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `CT-0021-AC2` | Contract | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `UT-0021-AC3`, `CT-0021-AC3` | Unit, Contract | output command dan assertion | Belum dijalankan |
| [AC-4](test.md#ac-4) | `UT-0021-AC4`, `SEC-0021-AC4` | Unit, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-5](test.md#ac-5) | `UT-0021-AC5`, `CT-0021-AC5` | Unit, Contract | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `UT-0021-AC6`, `SEC-0021-AC6` | Unit, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-7](test.md#ac-7) | `CT-0021-AC7` | Contract | output command dan assertion | Belum dijalankan |
| [AC-8](test.md#ac-8) | `MANUAL-0021-AC8` | Manual atau external | review manusia atau artefak eksternal | Belum dijalankan |
| [AC-9](test.md#ac-9) | `CT-0021-AC9` | Contract | output command dan assertion | Belum dijalankan |
