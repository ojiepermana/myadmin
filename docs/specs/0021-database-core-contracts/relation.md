# Relation 0021. Kontrak database-core, capability model, dan registry
...
> spec 0001. Konsumen pertama: spec 0022 dan 0024.
...
|---|---|---|
| `enables` | [0022. Provider PostgreSQL: koneksi, TLS, capability, error mapping](../0022-postgresql-connection-capability/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0024. Provider MySQL: koneksi, TLS, capability, error mapping](../0024-mysql-connection-capability/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
