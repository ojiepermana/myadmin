...
| 2026-08-30 | working tree | macOS ARM64 binary dengan PostgreSQL disposable | Binary database smoke E2E **1 passed dalam 5,8 detik** dengan `--require-database`; artifact berhasil melalui smoke harness database. | [Binary smoke E2E evidence](../evidence/2026-08-30-binary-smoke-e2e.md) |
...
| 2026-08-30 | Working tree | macOS ARM64 binary, PostgreSQL 55433, MySQL 3380, database-required smoke | **2 pass, 0 fail**; binary terbaru melewati health, embedded SPA, setup/login/auth, database connection, shutdown, dan doctor pada PostgreSQL serta MySQL disposable | `bun run smoke:binary -- --binary dist/binaries/macos-arm64/myadmin --database-url 'postgres://myadmin_test:<fixture-password>@127.0.0.1:55433/myadmin_test?sslmode=disable' --require-database`; `bun run smoke:binary -- --binary dist/binaries/macos-arm64/myadmin --database-url 'mysql://fixture:<fixture-password>@127.0.0.1:3380/fixture?sslmode=require' --require-database` |
