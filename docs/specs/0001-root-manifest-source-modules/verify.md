# Verify 0001. Fondasi repo satu manifest dan modul source
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `SMOKE-0001-AC1` | Smoke dan operational | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `SMOKE-0001-AC2` | Smoke dan operational | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `SMOKE-0001-AC3` | Smoke dan operational | output command dan assertion | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0001-AC4` | Integration | output command dan assertion | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0001-AC5` | Integration | output command dan assertion | Belum dijalankan |
| [AC-6](test.md#ac-6) | `IT-0001-AC6` | Integration | output command dan assertion | Belum dijalankan |
| [AC-7](test.md#ac-7) | `IT-0001-AC7` | Integration | output command dan assertion | Belum dijalankan |
| [AC-8](test.md#ac-8) | `SMOKE-0001-AC8` | Smoke dan operational | output command dan assertion | Belum dijalankan |
| [AC-9](test.md#ac-9) | `SMOKE-0001-AC9` | Smoke dan operational | output command dan assertion | Belum dijalankan |
