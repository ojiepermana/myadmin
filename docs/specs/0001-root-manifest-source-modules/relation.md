# Relation 0001. Fondasi repo satu manifest dan modul source
...
|---|---|---|
| `enables` | [0002. Quality tooling dan CI](../0002-quality-tooling-ci/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0003. Struktur kontrak OpenAPI v1 dan error model](../0003-openapi-contract-structure/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0006. CLI runtime dan data directory](../0006-cli-runtime-data-directory/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0014. UI foundation dan theme](../0014-ui-foundation-theme/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
| `enables` | [0021. Kontrak database-core, capability model, dan registry](../0021-database-core-contracts/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
