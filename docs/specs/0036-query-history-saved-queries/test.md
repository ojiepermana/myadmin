...
saved queries CRUD: `GET/POST/PATCH/DELETE /query/saved`; nama wajib dan unik per user (409 bila bentrok), SQL wajib, konteks opsional (connectionId, database); membuka saved query membuat tab baru dengan konteksnya.
