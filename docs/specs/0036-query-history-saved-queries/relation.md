# Relation 0036. Query history dan saved queries
...
| `references` | [0026. Connection manager: CRUD dan vault](../0026-connection-manager-crud/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
