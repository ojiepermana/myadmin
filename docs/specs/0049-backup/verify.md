...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `UT-0049-AC1`, `IT-0049-AC1`, `CT-0049-AC1`, `SMOKE-0049-AC1` | Unit, Integration, Contract, Smoke dan operational | output command dan assertion; Bukti membutuhkan native tools dan server database target. | Belum dijalankan |
| [AC-2](test.md#ac-2) | `UT-0049-AC2`, `IT-0049-AC2`, `CT-0049-AC2`, `SEC-0049-AC2` | Unit, Integration, Contract, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0049-AC3`, `SMOKE-0049-AC3` | Integration, Smoke dan operational | output command dan assertion | Belum dijalankan |
| [AC-4](test.md#ac-4) | `UT-0049-AC4`, `IT-0049-AC4`, `SEC-0049-AC4` | Unit, Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0049-AC5`, `CT-0049-AC5`, `E2E-0049-AC5`, `SEC-0049-AC5` | Integration, Contract, E2E, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-6](test.md#ac-6) | `IT-0049-AC6`, `E2E-0049-AC6`, `SEC-0049-AC6` | Integration, E2E, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-7](test.md#ac-7) | `UT-0049-AC7`, `IT-0049-AC7`, `CT-0049-AC7`, `E2E-0049-AC7` | Unit, Integration, Contract, E2E | output command dan assertion | Belum dijalankan |
| [AC-8](test.md#ac-8) | `IT-0049-AC8`, `E2E-0049-AC8`, `SMOKE-0049-AC8` | Integration, E2E, Smoke dan operational | output command dan assertion; Bukti membutuhkan native tools serta PostgreSQL dan MySQL nyata. | Belum dijalankan |
...
|---|---|---|---|---|
| `EVIDENCE-0049-AC1` | [AC-1](test.md#ac-1) | Bukti membutuhkan native tools dan server database target. | Seluruh kewajiban AC terbukti tanpa mengganti external proof dengan simulasi lokal. | Belum ada |
| `EVIDENCE-0049-AC8` | [AC-8](test.md#ac-8) | Bukti membutuhkan native tools serta PostgreSQL dan MySQL nyata. | Seluruh kewajiban AC terbukti tanpa mengganti external proof dengan simulasi lokal. | Belum ada |
