...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0007. Perintah doctor dan migrate](../0007-doctor-migrate-commands/index.md) | Indeks build dan konteks spec |
...
|---|---|---|
| `enables` | [0050. Restore](../0050-restore/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
...
| `references` | [0011. Credential vault dan redaction](../0011-credential-vault-redaction/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
