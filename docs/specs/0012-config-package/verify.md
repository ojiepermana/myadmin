...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `UT-0012-AC1` | Unit | output command dan assertion | Belum dijalankan |
| [AC-2](test.md#ac-2) | `UT-0012-AC2` | Unit | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `IT-0012-AC3` | Integration | output command dan assertion | Belum dijalankan |
| [AC-4](test.md#ac-4) | `UT-0012-AC4` | Unit | output command dan assertion | Belum dijalankan |
| [AC-5](test.md#ac-5) | `SEC-0012-AC5` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-6](test.md#ac-6) | `IT-0012-AC6`, `SEC-0012-AC6` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-7](test.md#ac-7) | `UT-0012-AC7` | Unit | output command dan assertion | Belum dijalankan |
...
|---|---|---|
| Unit | Script root yang didaftarkan pada satu `package.json` | Semua `UT-0012-*` lulus dan memiliki assertion yang menutup AC. |
| Integration | Script root yang didaftarkan pada satu `package.json` | Resource nyata disposable dipakai dan cleanup lulus. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0012-*` lulus dan memiliki assertion yang menutup AC. |
