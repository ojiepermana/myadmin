...
| `coordinates` atau `deferred` | [0033. Query editor: tab dan eksekusi](../0033-query-editor-execution/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
