# Relation 0003. Struktur kontrak OpenAPI v1 dan error model
...
| Jenis | Spec | Sumber |
|---|---|---|
| `requires` | [0001. Fondasi repo satu manifest dan modul source](../0001-root-manifest-source-modules/index.md) | Indeks build dan konteks spec |
...
|---|---|---|
| `enables` | [0004. Pipeline codegen dan contract test](../0004-codegen-pipeline-contract-tests/index.md) | Spec ini harus selesai sebelum konsumen dimulai |

## Relasi nonblocking dan handoff

| Jenis awal | Spec | Cara membaca relasi |
|---|---|---|
| `coordinates` atau `deferred` | [0013. Package observability](../0013-observability-package/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0016. Initial setup end to end](../0016-initial-setup-flow/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0022. Provider PostgreSQL: koneksi, TLS, capability, error mapping](../0022-postgresql-connection-capability/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0017. Login, logout, dan session](../0017-login-session/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
| `coordinates` atau `deferred` | [0024. Provider MySQL: koneksi, TLS, capability, error mapping](../0024-mysql-connection-capability/index.md) | Referensi berbentuk daftar, rentang, atau nomor singkat pada spec utama. Baca konteks sebelum mengubah graph build. |
