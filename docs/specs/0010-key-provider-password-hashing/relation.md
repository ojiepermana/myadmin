# Relation 0010. Key provider dan password hashing
...
> spec 0006 (data directory, tempat keyfile default).
...
|---|---|---|
| `enables` | [0011. Credential vault dan redaction](../0011-credential-vault-redaction/index.md) | Spec ini harus selesai sebelum konsumen dimulai |
...
|---|---|---|
| `references` | [0007. Perintah doctor dan migrate](../0007-doctor-migrate-commands/index.md) | Mention dalam spec utama bukan otomatis prasyarat. Baca konteks sebelum mengubah graph build. |
