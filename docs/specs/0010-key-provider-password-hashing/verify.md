# Verify 0010. Key provider dan password hashing
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0010-AC1`, `SEC-0010-AC1` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-2](test.md#ac-2) | `UT-0010-AC2` | Unit | output command dan assertion | Belum dijalankan |
| [AC-3](test.md#ac-3) | `SEC-0010-AC3` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0010-AC4`, `SEC-0010-AC4` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-5](test.md#ac-5) | `SEC-0010-AC5` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-6](test.md#ac-6) | `SEC-0010-AC6`, `PERF-0010-AC6` | Security, Performance | output command dan assertion; dataset, baseline, ambang, pengulangan, dan toleransi; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-7](test.md#ac-7) | `UT-0010-AC7` | Unit | output command dan assertion | Belum dijalankan |
| [AC-8](test.md#ac-8) | `SEC-0010-AC8` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-9](test.md#ac-9) | `UT-0010-AC9` | Unit | output command dan assertion | Belum dijalankan |
...
|---|---|---|
| Unit | Script root yang didaftarkan pada satu `package.json` | Semua `UT-0010-*` lulus dan memiliki assertion yang menutup AC. |
| Integration | Script root yang didaftarkan pada satu `package.json` | Resource nyata disposable dipakai dan cleanup lulus. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0010-*` lulus dan memiliki assertion yang menutup AC. |
