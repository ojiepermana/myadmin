# Verify 0017. Login, logout, dan session
...
|---|---|---|---|---|
| [AC-1](test.md#ac-1) | `IT-0017-AC1`, `SEC-0017-AC1` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-2](test.md#ac-2) | `SEC-0017-AC2`, `PERF-0017-AC2` | Security, Performance | output command dan assertion; dataset, baseline, ambang, pengulangan, dan toleransi; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-3](test.md#ac-3) | `SEC-0017-AC3` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-4](test.md#ac-4) | `IT-0017-AC4`, `SEC-0017-AC4` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-5](test.md#ac-5) | `IT-0017-AC5`, `SEC-0017-AC5`, `PERF-0017-AC5` | Integration, Security, Performance | output command dan assertion; dataset, baseline, ambang, pengulangan, dan toleransi; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-6](test.md#ac-6) | `IT-0017-AC6` | Integration | output command dan assertion | Belum dijalankan |
| [AC-7](test.md#ac-7) | `SEC-0017-AC7` | Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-8](test.md#ac-8) | `E2E-0017-AC8`, `VIS-0017-AC8` | E2E, Visual dan accessibility | output command dan assertion; screenshot dengan viewport dan state terkunci | Belum dijalankan |
| [AC-9](test.md#ac-9) | `IT-0017-AC9`, `SEC-0017-AC9` | Integration, Security | output command dan assertion; log tersanitasi tanpa secret | Belum dijalankan |
| [AC-10](test.md#ac-10) | `IT-0017-AC10` | Integration | output command dan assertion | Belum dijalankan |
...
| E2E | Script root yang didaftarkan pada satu `package.json` | Semua `E2E-0017-*` lulus dan memiliki assertion yang menutup AC. |
| Security | Script root yang didaftarkan pada satu `package.json` | Semua `SEC-0017-*` lulus dan memiliki assertion yang menutup AC. |
