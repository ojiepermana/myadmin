...
| [AC-2](test.md#ac-2) | `SEC-0053-AC2`, `SMOKE-0053-AC2`                             | Security, Smoke dan operational                          | output command dan assertion; log tersanitasi tanpa secret                                                                  | Parsial lokal; secret scanner menerima fixture aman dan mendeteksi pola credential pada negative fixtures, tetapi smoke/hosted proof belum |
...
| ---- | --------------------------------------------------------------------------------------------------------------------------- | --------------------------------- | ---------------------------------------------------------------- |
| AC-8 | Local security suite lulus, tetapi hosted workflow `security.yml`, clean environment, dan operational proof belum tersedia. | Verdict tetap belum diverifikasi. | Jalankan workflow hosted dan tautkan artifact/run yang berhasil. |
