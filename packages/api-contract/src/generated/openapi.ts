...
export interface paths {
    ...
    "/import/csv": {
        ...
        get?: never;
        put?: never;
        /** Queue a parameterized CSV import job */
        post: operations["createImportCsv"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/import/preview": {
        ...
        /** Read a bounded server side import preview */
        get: operations["previewImport"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/import/sql": {
        ...
        get?: never;
        put?: never;
        /** Queue a streaming SQL import job */
        post: operations["createImportSql"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/import/upload": {
        ...
        get?: never;
        put?: never;
        /** Stream an SQL or CSV import upload */
    ...
    "/tables/drop": {
        ...
        put?: never;
        post?: never;
        /** Drop a table after exact name confirmation without cascade */
    ...
    "/tables/impact": {
        ...
        get?: never;
        put?: never;
        /** Inspect table destructive operation impact */
        post: operations["getTableDestructiveImpact"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/tables/rename": {
        ...
        get?: never;
        put?: never;
        /** Rename a table after exact old name confirmation */
        post: operations["renameTable"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/tables/truncate": {
        ...
        get?: never;
        put?: never;
        /** Truncate a table after exact name confirmation */
...
export interface components {
    schemas: {
        ...
        ImportCsvRequest: {
            confirmName?: string;
            connectionId: string;
            options?: components["schemas"]["CsvImportOptions"];
            ref: components["schemas"]["ImportObjectRef"];
            /** @default false */
        ...
        ImportSqlRequest: {
             ...
             * @enum {string}
             */
            transactionMode: "single" | "per-statement";
            uploadId: string;
        };
        ImportUpload: {
            /** Format: date-time */
        ...
        TableDestructiveImpact: {
            estimatedRows?: number;
            incomingForeignKeys: components["schemas"]["TableDependency"][];
            ref: components["schemas"]["TableOperationRef"];
            restartIdentityReason?: string;
            restartIdentitySupported: boolean;
            views: components["schemas"]["ExplorerObjectRef"][];
        };
        TableDropRequest: {
            confirmName: string;
            connectionId: string;
...
export interface operations {
    ...
    createImportCsv: {
        ...
        responses: {
            ...
            202: {
                ...
                content: {
                    "application/json": components["schemas"]["ImportCreateResponse"];
                };
            };
            /** @description No valid session was provided. */
            401: {
            ...
            /** @description Destructive confirmation or job limit conflict. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Import request or mapping is invalid. */
            422: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Provider import is unavailable. */
            501: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    previewImport: {
        ...
        requestBody?: never;
        responses: {
            /** @description At most twenty CSV rows or the first SQL statement. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Upload was not found or is not owned by the caller. */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    createImportSql: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ImportSqlRequest"];
            };
        };
        responses: {
            /** @description Import job queued. */
            ...
            /** @description Import job limit conflict. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Import request is invalid. */
            422: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    uploadImport: {
        ...
        responses: {
            /** @description Upload stored for one hour. */
            201: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Upload exceeds the configured streaming limit. */
            413: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Upload type or multipart data is invalid. */
            422: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    dropTable: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TableDropRequest"];
            };
        };
        responses: {
            /** @description Table dropped and audit recorded. */
            204: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Confirmation was wrong or the provider rejected dependencies. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The table reference is invalid. */
            422: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Table operations are not supported by this provider. */
            501: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getTableDestructiveImpact: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TableImpactRequest"];
            };
        };
        responses: {
            /** @description Provider metadata used by destructive action dialogs. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["TableDestructiveImpact"];
                };
            };
            /** @description No valid session was provided. */
            401: {
    ...
    renameTable: {
        ...
        responses: {
            /** @description Table renamed and audit recorded. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["TableOperationRef"];
                };
            };
            /** @description No valid session was provided. */
            401: {
            ...
            /** @description Confirmation was wrong or the rename conflicted. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The table reference or identifier is invalid. */
            422: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    truncateTable: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TableTruncateRequest"];
            };
        };
        responses: {
            /** @description Table truncated and audit recorded. */
            204: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Confirmation was wrong or the connection is not connected. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The requested restart identity option is not supported. */
            501: {
                headers: {
                    [name: string]: unknown;
                };
