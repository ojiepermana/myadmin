...
const initialPaths = {
  ...
  '/export': 'paths/export.yaml',
  '/export/{id}': 'paths/export-by-id.yaml',
  '/export/{id}/download': 'paths/export-by-id-download.yaml',
  '/import/upload': 'paths/import-upload.yaml',
  '/import/preview': 'paths/import-preview.yaml',
  '/import/sql': 'paths/import-sql.yaml',
  '/import/csv': 'paths/import-csv.yaml',
  ...
  '/connections/{id}/databases/options': 'paths/database-options.yaml',
  '/connections/{id}/databases/{db}/properties': 'paths/database-properties.yaml',
  ...
  '/tables/ddl/types': 'paths/table-ddl-types.yaml',
  '/tables/ddl/preview': 'paths/table-ddl-preview.yaml',
  '/tables/ddl/apply': 'paths/table-ddl-apply.yaml',
  '/tables/impact': 'paths/table-impact.yaml',
  '/tables/rename': 'paths/table-rename.yaml',
  '/tables/truncate': 'paths/table-truncate.yaml',
  '/tables/drop': 'paths/table-drop.yaml',
  ...
  '/security/principals/{name}/grants': 'paths/security-principal-grants.yaml',
  '/security/principals/{name}/reset-password': 'paths/security-principal-reset.yaml',
  '/security/privileges/catalog': 'paths/security-privilege-catalog.yaml',
  '/security/grants/preview': 'paths/security-grants.yaml',
  '/security/grants/apply': 'paths/security-grants-apply.yaml',
